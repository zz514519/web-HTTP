...
public class ResponseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //配合 Chrome 开发工具 OR Fiddler 进行观察
        //resp.setStatus(404);
       //resp.sendError(404,"今天真高兴");    setStatus + 填充正文
        //resp.sendRedirect("/");   //   setStatus(302) + setHeader("Location");

        //设置 HTTP 响应头
       // resp.setHeader("Key","Value");
       // resp.setHeader("Content-Type","zhangzhe");
        //resp.setHeader("Content-Type","text/html;charset=utf-8");
        //resp.setContentType("text.html;charset=utf-8"); //完全等价于 setHeader("Content-Type","text/html;charset=utf-8")
